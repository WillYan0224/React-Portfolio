export const TRANSLATIONS = {
  en: {
    ...
    hero: {
      ...
      desc: "I build interactive digital systems, bridging real-time graphics, data, and software engineering.",
      cta: "View My Work",
    },
    separator: {
      subtitle: "AI Era",
    ...
    featured: [
      {
        ...
        theme: "gold",
        desc: "A real-time satellite tracking and visualization system built with Python APIs and Cesium, enabling live orbital data exploration and geographic context.",
        video: "/videos/Satellite.mp4",
        modalVideo: "/videos/Satellite_1.mp4",
        external: "https://satellitefinder.pages.dev",
      ...
      },
      {
        ...
        external: "https://github.com/WillYan0224/DynamicSky",
        btn: "Watch Overview",
      },
    ],
    projects: {
